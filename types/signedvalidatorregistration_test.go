...
func TestSignedValidatorRegistrationJSON(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:  "JSONBad",
			input: []byte("[]"),
			err:   "invalid JSON: json: cannot unmarshal array into Go value of type types.signedValidatorRegistrationJSON",
		},
		{
			name:  "MessageMissing",
		...
		},
		{
			...
			err:   "invalid JSON: invalid JSON: json: cannot unmarshal bool into Go value of type types.validatorRegistrationJSON",
		},
		{
			name:  "MessageInvalid",
